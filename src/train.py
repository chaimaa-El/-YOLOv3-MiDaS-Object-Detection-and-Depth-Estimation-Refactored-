...
Script to train the Monocular Depth Estimation (MDE) network. This script initializes the model,
configures the training environment, prepares datasets, and optimizes the model parameters over epochs.
...
try:
    ...
    mixed_precision = False  # Fallback to standard precision if Apex is unavailable

# Paths and Directories
wdir = 'weights' + os.sep  # Directory for saving model weights
last = wdir + 'last.pt'    # Filepath for the last saved model
...
def train():
    """
    Main function to train the MDE network.

    Configures the model, dataset, optimizer, and scheduler, and initiates the training loop.
    """
    ...
    # Configure multi-scale training if enabled
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/mde.cfg', help='*.cfg path')
